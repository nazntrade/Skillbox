package com.example.hw_ViewModelAndNavigation.imagesLists
...
import com.example.hw_ViewModelAndNavigation.databinding.FragmentImageListBinding


class StaggeredGridImageListFragment : Fragment(R.layout.fragment_image_list) {
    ...
    private fun initList() = with(binding.imageList) {
        adapter = ImageAdapter().apply {
            setImages(images.shuffled() + images.shuffled() + images.shuffled())
        }
        setHasFixedSize(true)

//   I have done this task. It was working. But it doesn't need in this project.
