...
class EmployeeListFragment : Fragment(R.layout.fragment_employees) {
    ...
    private fun bindViewModel() {
        viewModel.employeeListLiveData.observe(viewLifecycleOwner) { employeeListAdapter.items = it }
    }
    ...
    private fun initList() {
        employeeListAdapter =
            EmployeeListAdapter(::addEmployeeToProjectListAndNavigateBack, viewModel::removeEmployee)
